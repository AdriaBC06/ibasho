...
abstract final class Ty {
  ...
  // Texto de interfaz.
  static TextStyle get micro => _ui(11, color: T.inkSoft);
  static TextStyle get caption => _ui(13, color: T.inkSoft);
  ...
  static TextStyle get label => _ui(13, color: T.inkSoft, letterSpacing: .3);
  ...
  static TextStyle numeral(double size, {Color color = T.ink, FontWeight weight = FontWeight.w500}) =>
      TextStyle(
        fontFamily: round,
        fontSize: size,
        fontWeight: weight,
