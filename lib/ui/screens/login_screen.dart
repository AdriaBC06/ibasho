            ...
            Row(
              ...
              children: [
                ...
                Column(
                  ...
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text(l.appName, style: Ty.logo(layout.pick(40, 32), Ty.ink)),
                    Text('居場所', style: Ty.logoJa(layout.pick(17, 15), Ty.inkSoft)),
                  ],
                ),
              ],
            ),
          ...
          children: [
            ...
            Expanded(
              child: Text(
                ...
                style: Ty.caption.copyWith(color: Ty.ink, height: 1.25),
              ),
            ),
          ],
        ),
